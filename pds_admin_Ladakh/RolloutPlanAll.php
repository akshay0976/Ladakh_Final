			...
			$.ajax({
				...
				success: function(result){
					...
					try{
						...
						var headers = ["Scenario", "Atta + Rice + Rice (Qtls) Moved", "Distance (Kms)", "QKM", "Ave. Distance (Kms)*", "%Reduction w.r.t Avg. Distance in Baseline"];
						...
						cell2.innerHTML = "31,949";
						cell3.innerHTML = "1,02,302";
						cell4.innerHTML = "14,60,092";
						cell5.innerHTML = "45.70";
						cell6.innerHTML = " ";
