                                    ...
                                    <table id="export_table" class="table datatable">
                                        <thead>
                                            <tr>
												...
												<th style="font-size:16px">Type of Mill</th>
												<th style="font-size:16px">Latitude</th>
												<th style="font-size:16px">Longitude</th>
												<th style="font-size:16px">Mill Capacity</th>
												<th style="font-size:16px">Mill Process</th>
                                            </tr>
                                        </thead>
                                        <tbody>
										<?php
    ...
    <!-- START SCRIPTS -->
		...
		document.getElementById('downloadCSV').addEventListener('click', async function() {
			try {
				...
				downloadFile(csvBlob, 'Ladakh_Mill_' + getDateString() + '.csv');
			} catch (error) {
		...
		document.getElementById('downloadXLSX').addEventListener('click', async function() {
			try {
				...
				downloadFile(excelBlob, 'Ladakh_Mill_' + getDateString() + '.xlsx');
			} catch (error) {
