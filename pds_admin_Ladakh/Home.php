...
<ul class="breadcrumb">
	<li><a href="#">Home</a></li>
	<li class="active">Ladakh PDS Route Optimisation</li>
</ul>
<!-- END BREADCRUMB -->
<div>
		...
		<div class="col-md-12">
			...
			<div class="panel panel-default">
				<div class="panel-heading" style="text-align: center;">
					<h1 style="font-weight: bold; color: #335566;">Ladakh PDS Route Optimisation</h1>
			...
			<div class="row" style="margin-top:150px">
				...
				<input type="hidden" id="username" name="username" value="<?php echo
$_SESSION["user"] ?>" />
				<div class="col-md-3">
					<div class="form-group">
						<div class="col-md-2"></div>
							...
							<div class="row">
								...
								<div class="col-md-4 mb-4">
									<div class="card h-100"
										...
										<div style="font-size:14px">Total Mill Processing</div>
									</div>
								</div>
							</div>
						</div>
	...
	function generateoptimizedplan() {
		...
		fetchPromise = fetch(pythonUrl + 'processFile', {
			...
			.then(data => {
				...
				var headers = ["Scenario", "From","To","From_Used", "To_Used", "Total_Allocation", "Total_QKM", "Average Distance"];
				...
				cell2.innerHTML = data["From"];
				cell3.innerHTML = data["To"];
				cell4.innerHTML = data["WH_Used"];
				cell5.innerHTML = formatNumberWithCommas(data["FPS_Used"]);
				cell6.innerHTML = formatNumberWithCommas(data["Demand"]);
				cell7.innerHTML = formatNumberWithCommas(data["Total_QKM"]);
				cell8.innerHTML = formatNumberWithCommas(data["Average_Distance"]);
				...
				cell2.innerHTML = data["From_Baseline"];
				cell3.innerHTML = data["To_Baseline"];
				cell4.innerHTML = data["WH_Used_Baseline"];
				cell5.innerHTML = (data["FPS_Used_Baseline"]);
				cell6.innerHTML = (data["Demand_Baseline"]);
				cell7.innerHTML = (data["Total_QKM_Baseline"]);
				cell8.innerHTML = (data["Average_Distance_Baseline"]);
				...
				cell1.innerHTML = data["Scenario1"];
				cell2.innerHTML = data["From1"];
				cell3.innerHTML = data["To1"];
				cell4.innerHTML = data["WH_Used1"];
				cell5.innerHTML = formatNumberWithCommas(data["FPS_Used1"]);
				cell6.innerHTML = formatNumberWithCommas(data["Demand1"]);
				cell7.innerHTML = formatNumberWithCommas(data["Total_QKM1"]);
				cell8.innerHTML = formatNumberWithCommas(data["Average_Distance1"]);
				...
				cell1.innerHTML = data["Scenario_Baseline1"];
				cell2.innerHTML = data["From_Baseline1"];
				cell3.innerHTML = data["To_Baseline1"];
				cell4.innerHTML = data["WH_Used_Baseline1"];
				cell5.innerHTML = (data["FPS_Used_Baseline1"]);
				cell6.innerHTML = (data["Demand_Baseline1"]);
				cell7.innerHTML = (data["Total_QKM_Baseline1"]);
				cell8.innerHTML = (data["Average_Distance_Baseline1"]);
	...
	if (checkbox.checked) {
		...
		fetch(pythonUrl + 'getGraphData', {
			...
			.then(data => {
				...
				document.getElementById("totalmillprocessing").innerHTML = "<span style='color: white; font-size: 14px;'>" + "Total Mill Processing: " + totalprocessing.toFixed(2) + " (Qtl)</span>";
				...
				if (totalCapacity > 0 && totalDemand > 0) {
					if (totalCapacity >= totalDemand) {
						...
						document.getElementById("result").innerHTML = "<span style='font-weight: bold; font-size: 20px; color: red;'>Optimiasation cannot be done infeasible solution.</span>";
						document.getElementById("districtcheckbox").style.display = "none";
						document.getElementById("generateoptinizedplanbutton").style.display = "none";
					}
